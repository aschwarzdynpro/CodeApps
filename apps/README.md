...
| [`approval-cockpit/genpage/`](approval-cockpit/genpage/) | Dieselbe Inbox als **Generative Page** für model-driven Apps — read-only auf den echten Power-Automate-Approval-Tabellen. |
...
| [`mein-tag/genpage/`](mein-tag/genpage/) | **Generative Page** in Sales Hub — meine Aktivitäten nach Fälligkeit (Heute / Überfällig / Demnächst / Ohne Termin) plus Opportunities und Leads, die seit N Tagen still liegen. |
