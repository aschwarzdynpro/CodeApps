...
export const leadsTile: TileDef<Lead> = {
  ...
  columns: [
    ...
    { key: 'owner', label: 'Besitzer', value: (r) => r.owner.name, defaultHidden: true },
    { key: 'createdBy', label: 'Erstellt von', value: (r) => r.createdBy.name, defaultHidden: true },
  ],
  rowId: (row) => row.id,
  searchText: (row) =>
...
export const opportunitiesTile: TileDef<Opportunity> = {
  ...
  columns: [
    ...
    { key: 'contact', label: 'Kontakt', value: (r) => r.contact, defaultHidden: true },
    { key: 'status', label: 'Status', value: (r) => r.status, defaultHidden: true },
    { key: 'gvl', label: 'GVL', value: (r) => r.areaSalesManager.name, defaultHidden: true },
    { key: 'owner', label: 'Besitzer', value: (r) => r.owner.name, defaultHidden: true },
    { key: 'created', label: 'Erstellt am', kind: 'date', value: (r) => r.createdOn, defaultHidden: true },
  ],
  rowId: (row) => row.id,
...
export const projectsTile: TileDef<Project> = {
  ...
  columns: [
    ...
    { key: 'gvl', label: 'GVL', value: (r) => r.areaSalesManager.name, defaultHidden: true },
    { key: 'kam', label: 'KAM', value: (r) => r.keyAccountManager.name, defaultHidden: true },
    { key: 'revenue', label: 'Ist-Umsatz', kind: 'currency', value: (r) => r.actualRevenue, defaultHidden: true },
    { key: 'delivery', label: 'Liefertermin', kind: 'date', value: (r) => r.estimatedDeliveryDate, defaultHidden: true },
    { key: 'owner', label: 'Besitzer', value: (r) => r.owner.name, defaultHidden: true },
    { key: 'created', label: 'Erstellt am', kind: 'date', value: (r) => r.createdOn, defaultHidden: true },
  ],
  rowId: (row) => row.id,
...
export const quotesTile: TileDef<Quote> = {
  ...
  columns: [
    ...
    { key: 'kam', label: 'KAM', value: (r) => r.keyAccountManager.name },
    { key: 'accountNumber', label: 'Kundennr.', value: (r) => r.accountNumber, defaultHidden: true },
    { key: 'gvl', label: 'GVL', value: (r) => r.areaSalesManager.name, defaultHidden: true },
    { key: 'opportunity', label: 'Verkaufschance', value: (r) => r.opportunity, defaultHidden: true },
    { key: 'owner', label: 'Besitzer', value: (r) => r.owner.name, defaultHidden: true },
    { key: 'created', label: 'Erstellt am', kind: 'date', value: (r) => r.createdOn, defaultHidden: true },
  ],
  rowId: (row) => row.id,
...
export const ordersTile: TileDef<SalesOrder> = {
  ...
  columns: [
    ...
    { key: 'accountNumber', label: 'Kundennr.', value: (r) => r.accountNumber, defaultHidden: true },
    { key: 'kam', label: 'KAM', value: (r) => r.keyAccountManager.name, defaultHidden: true },
    { key: 'externalOrder', label: 'Externe Auftragsnr.', value: (r) => r.externalOrderNumber, defaultHidden: true },
    { key: 'opportunity', label: 'Verkaufschance', value: (r) => r.opportunity, defaultHidden: true },
    { key: 'owner', label: 'Besitzer', value: (r) => r.owner.name, defaultHidden: true },
    { key: 'created', label: 'Erstellt am', kind: 'date', value: (r) => r.createdOn, defaultHidden: true },
  ],
